            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <p className="text-gray-400 text-sm leading-relaxed">
                        A leading scientific publishing platform dedicated to
                        disseminating innovative research and cutting-edge
                ...
                <div>
                    ...
                    <p className="text-gray-400 text-sm mb-2">
                        Email: journal@adra.ac.id
                    </p>
                    <p className="text-gray-400 text-sm mb-2">
                        Telephone: +6285156342096
                    </p>
                    <p className="text-gray-400 text-sm">
                        Address: Jorong Kubang Kaciak Dusun Kubang Kaciak,
                        Kelurahan Balai Tangah, Kecamatan Lintau Buo Utara,
                        Kabupaten Tanah Datar, Provinsi Sumatera Barat, Kodepos
                        27293.
                    </p>
